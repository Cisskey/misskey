...
<div class="vvcocwet" :class="{ wide: !narrow }" ref="el">
	<FormBase class="nav" v-if="!narrow || page == null" :force-wide="!narrow">
		...
		<FormGroup>
			...
			<FormLink :active="page === 'cw-content'" replace to="/settings/cw-content"><template #icon><Fa :icon="faEyeSlash"/></template>{{ $ts.autoShowCwContent }}</FormLink>
...
import { faCog, faPalette, faPlug, faUser, faListUl, faLock, faCommentSlash, faMusic, faCogs, faEllipsisH, faBan, faShareAlt, faLockOpen, faKey, faBoxes, faCloud, faLink, faEyeSlash } from '@fortawesome/free-solid-svg-icons';
...
export default defineComponent({
	...
	setup(props, context) {
		...
		return {
			...
			faPalette, faPlug, faUser, faListUl, faLock, faLaugh, faCommentSlash, faMusic, faBell, faCogs, faEllipsisH, faBan, faShareAlt, faLockOpen, faKey, faBoxes, faLink, faEyeSlash, faEnvelope, faCloud,
		};
	},
});
</script>
