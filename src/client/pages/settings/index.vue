...
<div class="vvcocwet" :class="{ wide: !narrow }" ref="el">
	<div class="nav" v-if="!narrow || $route.name === 'settings'">
		<div class="menu">
			...
			<router-link class="item" replace to="/settings/webhook"><Fa :icon="faLink" fixed-width class="icon"/>{{ $t('webhookNotification') }}</router-link>
		...
		<div class="menu">
			...
			<router-link class="item" replace to="/settings/cw-content"><Fa :icon="faEyeSlash" fixed-width class="icon"/>{{ $t('autoShowCwContent') }}</router-link>
