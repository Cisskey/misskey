	...
	<div class="nav" v-if="!narrow || page == null">
		<FormBase>
			...
			<FormGroup>
				...
				<FormLink :active="page === 'webhook'" replace to="/settings/webhook"><template #icon><i class="fas fa-link"></i></template>{{ $ts.webhookNotification }}</FormLink>
				<FormLink :active="page === 'cw-content'" replace to="/settings/cw-content"><template #icon><i class="fas fa-eye-slash"></i></template>{{ $ts.autoShowCwContent }}</FormLink>
			</FormGroup>
			<FormGroup>
