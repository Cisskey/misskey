...
<div class="vvcocwet" :class="{ wide: !narrow }" ref="el">
	<FormBase class="nav" v-if="!narrow || page == null" :force-wide="!narrow">
		<FormGroup>
			...
			<FormLink :active="page === 'webhook'" replace to="/settings/webhook"><template #icon><Fa :icon="faLink"/></template>{{ $t('webhookNotification') }}</FormLink>
		...
		<FormGroup>
			...
			<FormLink :active="page === 'cw-content'" replace to="/settings/cw-content"><template #icon><Fa :icon="faEyeSlash"/></template>{{ $t('autoShowCwContent') }}</FormLink>
...
export default defineComponent({
	...
	setup(props, context) {
		...
		return {
			...
			faPalette, faPlug, faUser, faListUl, faLock, faLaugh, faCommentSlash, faMusic, faBell, faCogs, faEllipsisH, faBan, faShareAlt, faLockOpen, faKey, faBoxes, faLink, faEyeSlash, faEnvelope,
		};
	},
});
</script>
