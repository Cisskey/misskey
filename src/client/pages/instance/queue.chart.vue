...
export default defineComponent({
	...
	methods: {
		...
		fetchJobs() {
			os.api(this.domain === 'inbox' ? 'admin/queue/inbox-delayed' : this.domain === 'deliver' ? 'admin/queue/deliver-delayed' : this.domain === 'webhook' ? 'admin/queue/webhook-delayed' : null, {}).then(jobs => {
				this.jobs = jobs;
			});
		},
