...
>
	...
	<div class="form" :class="{ fixed }">
		...
		<footer>
			...
			<button class="_button" @click="useHashtag = !useHashtag" :class="{ active: useHashtag }" v-tooltip="$ts.hashtag"><Fa :icon="faHashtag"/></button>
		</footer>
	</div>
</div>
</template>
...
import { faReply, faQuoteRight, faPaperPlane, faTimes, faUpload, faPollH, faGlobe, faHome, faUnlock, faEnvelope, faPlus, faPhotoVideo, faAt, faBiohazard, faPlug, faHashtag } from '@fortawesome/free-solid-svg-icons';
