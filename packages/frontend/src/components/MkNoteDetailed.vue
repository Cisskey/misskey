...
>
	...
	<article :class="$style.note" @contextmenu.stop="onContextmenu">
		...
		<footer>
			...
			<button v-if="appearNote.myReaction == null || appearNote.reactionAcceptance !== 'likeOnly'" ref="reactButton" :class="$style.noteFooterButton" class="_button" @mousedown="react()">
				<i v-if="appearNote.reactionAcceptance === 'likeOnly'" class="ti ti-heart"></i>
				<i v-else class="ti ti-plus"></i>
			</button>
			<button v-if="appearNote.myReaction != null && appearNote.reactionAcceptance === 'likeOnly'" ref="reactButton" class="_button" :class="[$style.noteFooterButton, $style.reacted]" @click="undoReact(appearNote)">
